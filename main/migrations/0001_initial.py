    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('targets', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=65536, validators=[main.validators.validate_chr_or_seq_or_enst]), default=['chr7:5569176-5569415', 'chr1:11,130,540-11,130,751'], help_text='Chr location or seq or ENST, one per line', size=None)),
                ('tag_in', models.CharField(blank=True, choices=[('FLAG', 'FLAG'), ('3XFLAG', '3XFLAG'), ('V5', 'V5'), ('HA', 'HA'), ('MYC', 'MYC'), ('TODO', 'TODO: tag used by Manu group')], max_length=40, null=True)),
                ('guide_data', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default={}, null=True)),
                ('donor_data', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default={}, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('selected_guides_tagin', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default={}, help_text='sgRNAs from tagin.stembio.org', null=True)),
                ('selected_donors', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default={}, help_text='ssDNAs from tagin.stembio.org', null=True)),
                ('selected_guides', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default={}, help_text='sgRNAs from crispor.tefor.net', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('selected_primers', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default={}, help_text='Primers from crispor.tefor.net', null=True)),
